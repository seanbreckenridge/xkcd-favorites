...
generate_html() {
	...
	while IFS= read -r info; do
		...
		printf '<figure class="p-2 text-center"><a href="%s"><img src="%s"></a><figcaption><a class="mt-1 badge badge-pill" href="https://xkcd.com/%d">https://xkcd.com/%d</a></figcaption></figure>' "${arr[1]}" "${arr[1]}" "${arr[0]}" "${arr[0]}"
	done<<<"$DATA_LINES"
}
